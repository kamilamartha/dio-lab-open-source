...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/kamilamartha: git checkout -b feat/community/kamilamartha`;
    > Exemplo: `git checkout -b feat/community/kamilamartha`
